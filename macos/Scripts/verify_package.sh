...
EXPECTED_VERSION="${DIVAN_NATIVE_VERSION:-2026.08.22.14}"
EXPECTED_BUILD="${DIVAN_NATIVE_BUILD_VERSION:-2026082214}"
...
critical = {
    ...
    "index.html": "9c58ff43ae90febd61c4fe2066fd7ee7649fb232af44bd2a716dc287581672d0",
