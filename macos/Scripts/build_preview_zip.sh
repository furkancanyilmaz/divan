...
CORE_SOURCE="${DIVAN_CORE_ROOT:-${PROJECT_DIR:h}/core}"
...
VERSION="${DIVAN_NATIVE_VERSION:-2026.08.11.5}"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 2026081106" "$PLIST"
